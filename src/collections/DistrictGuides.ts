...
export const DistrictGuides: CollectionConfig = {
  ...
  admin: { group: "İçerik", useAsTitle: "district", defaultColumns: ["district", "_status", "updatedAt"] },
  fields: [
    { name: "district", type: "select", required: true, unique: true, index: true, options: districtOptions, label: "İlçe" },
    { type: "tabs", tabs: [
      { label: "İlçeyi Tanı", fields: [
      ...
      { label: "Yayın", fields: [ { name: "publishedAt", type: "date", label: "Yayın tarihi" } ] },
    ] },
  ],
