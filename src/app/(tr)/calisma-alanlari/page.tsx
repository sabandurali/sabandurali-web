...
export default function WorkspacesPage() {
  return <WorkspaceLandingPage workspace={{ key: "arastirma-ve-analiz", title: "Çalışma Alanları", eyebrow: "Platform yapısı", description: "Şaban Durali platformunun altı ana çalışma alanına buradan erişin.", icon: "network", entries: workspaces.map((workspace) => ({ slug: workspace.key, title: workspace.title, description: workspace.description, href: `/${workspace.key}` })) }} path={workspacePath} />;
}
