...
export default async function RealEstateSectionPage({ params }: Props) { const { section } = await params; const entry = getWorkspaceEntry(workspace.key, section); if (entry === null || entry.href === "/istanbul/ilceler") notFound(); return <WorkspaceEntryPage workspace={workspace} entry={entry} />; }
