...
export default async function ResearchSectionPage({ params }: Props) { const { section } = await params; const entry = getWorkspaceEntry(workspace.key, section); if (entry === null) notFound(); return <WorkspaceEntryPage workspace={workspace} entry={entry} />; }
