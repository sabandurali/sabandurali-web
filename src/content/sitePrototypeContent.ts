...
export const prototypePages = [
  ...
  page("law", "law", "listing", "candidate", "mevzuat-bankasi", "law-bank", "Mevzuat Bankası", "Law Bank", "Gayrimenkulle ilgili mevzuatı konu başlıklarıyla düzenleyen prototip.", "Prototype organizing real-estate legislation by topic."),
  page("law-detail", "law", "detail", "prototype", "mevzuat-bankasi/kira-iliskileri", "law-bank/tenancy-relations", "Kira İlişkileri", "Tenancy Relations", "Hukuki danışmanlık yerine geçmeyen örnek mevzuat özeti.", "Sample legal summary that is not legal advice."),
  ...
  page("current", "current", "listing", "candidate", "guncel", "current", "Güncel", "Current", "Dört örnek güncel içerik kartı.", "Four sample current-content cards."),
