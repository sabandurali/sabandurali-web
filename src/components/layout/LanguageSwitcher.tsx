    ...
    <div
      ...
      className={
        isMobile
          ...
          : "hidden shrink-0 items-center rounded-full border border-border px-3 py-2 text-xs font-medium text-ivory transition-colors hover:border-accent hover:bg-surface motion-reduce:transition-none sm:px-4 xl:flex"
      }
    >
