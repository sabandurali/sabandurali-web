...
export default function HomeListingSection({
  ...
  return (
    <section className={tone === "soft" ? "bg-surface-soft" : "bg-background"}>
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:px-10 lg:py-24">
        <div className="mb-10 flex flex-col gap-5 border-b border-border pb-7 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            href={href}
            className="inline-flex min-h-11 items-center self-start text-sm font-semibold text-accent-strong underline decoration-border underline-offset-4 transition-colors hover:text-ivory motion-reduce:transition-none sm:self-auto"
          >
            {content.linkLabel} →
          </Link>
        </div>
