    ...
    >
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h3 id="district-map-heading" className="mt-2 text-3xl text-ivory">
            {district.name} nerede?
          </h3>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-muted">
            İlçe ve mahalle sınırlarını İBB Şehir Haritası üzerinden
            inceleyebilirsiniz. Konum bağlantısı ilçe merkezini gösterir.
          </p>
        </div>
        <div className="flex flex-wrap gap-3 text-sm">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-11 items-center border border-accent px-4 font-semibold text-accent-soft hover:border-accent-soft hover:text-ivory"
          >
            İBB Şehir Haritası’nda aç <span aria-hidden="true">↗</span>
          </a>
          <a
            href={osmUrl}
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-11 items-center border border-border px-4 text-muted hover:text-ivory"
          >
            Konumu aç <span aria-hidden="true">↗</span>
          </a>
        </div>
      </div>
    </section>
