...
export default function FeedbackForm({ content }: FeedbackFormProps) {
  ...
  return (
    <form
      ...
      aria-busy={isLoading}
      aria-describedby="feedback-data-notice"
      className="space-y-4"
    >
      <p
        id="feedback-data-notice"
        className="rounded-sm border border-accent bg-surface px-5 py-4 text-sm leading-6 text-muted"
      >
        {content.dataNotice}
      </p>
      ...
      <fieldset disabled={isLoading} className="space-y-4 border-0 p-0">
        ...
        <PrivacyAcknowledgement
          id="feedback-privacy-acknowledgement"
